...
- **022** [[022-school-auth-is-a-real-login-window|学校系统的鉴权是一次真人登录加 Cookie 搬运，程序不碰密码]] — 2026-09-06 — tags: collection, architecture; cited by 1
- **023** [[023-mail-secrets-encrypted-at-rest|邮箱授权码密文入库、明文只在内存，账号是库里的数据不是配置]] — 2026-09-06 — tags: collection, architecture
